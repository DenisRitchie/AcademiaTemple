...
int main(void)
{
	...
	hPipeServer = CreateNamedPipe(TEXT("\\\\.\\pipe\\PipeServer"),
		PIPE_ACCESS_DUPLEX,
	...
	while (indice < 80)
	{
		...
		*/
		...
		int tamaniocoord = coordenadas.length();
		
		char* carro1 = const_cast<char*>(coordenadas.c_str());


		std::this_thread::sleep_for(std::chrono::milliseconds(600));
	   		
		hPipe = CreateFile(TEXT("\\\\.\\pipe\\Pipecarrito1"),
